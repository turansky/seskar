...
internal class WorkletTransformer(
    private val context: IrPluginContext,
) : IrElementTransformerVoid() {
    override fun visitProperty(declaration: IrProperty): IrStatement {
        if (!declaration.isWorkletModule())
            return declaration
        ...
        val jsName = sequenceOf(
            ...
            separator = WORKLET_MODULE_DELIMITER,
            prefix = WORKLET_MODULE_DELIMITER,
            postfix = WORKLET_MODULE_DELIMITER,
        )
