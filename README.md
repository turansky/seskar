...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.turansky.seskar/seskar-core?logo=apache-maven)](https://central.sonatype.com/artifact/io.github.turansky.seskar/seskar-core)
...
plugins {
  ...
  id("io.github.turansky.seskar") version "4.42.0"
}
```
